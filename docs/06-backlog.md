...
| # | 母版图上是 | 文档里是 |
|---|---|---|
| 1 | 图例写「冰箱 = 吃 / 家里有什么 / 不出门吃什么」 | #52 与 `02-system.md`：冰箱 = 私人菜谱库 |
| 2 | 时间展示例为五段：清晨 / 白天 / 傍晚 / 夜晚 / 深夜 | `04-art.md`：早朝 / 白天 / 夕方 / 夜晚，四段 |
| 3 | 鱼缸是亮粉与薄荷绿的**珊瑚礁**造型 | 造景方向要求圆润景石成组、不做珊瑚枝 |
| 4 | 图例写「植物状态（季节变化）」 | `04-art.md` Seasonal 层：室内盆栽第一版固定 |
| 5 | 图例仍列「记一笔」为第一版入口 | 已由 #65 推迟到下期 |
